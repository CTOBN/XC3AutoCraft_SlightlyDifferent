...
2つのプログラムが連動し、予め設定したアクセサリーが出るまでクラフトとリロードを繰り返します。
...
もしインストール版のArduinoを既に所持していて、PC環境を汚したくない場合はportable版をおすすめします。
3. (portable版の方は)arduino.exeと同じ階層にportableという名前のフォルダを新規作成する。
...
11. キャプチャボードでNintendo Switchの映像をPCに送る。
...
## 問い合わせ
質問・バグ報告・改善案などがありましたらIssueを作成するかこちらのTwitterアカウント[@ito_eight](https://twitter.com/ito_eight)のDMにてお知らせください。